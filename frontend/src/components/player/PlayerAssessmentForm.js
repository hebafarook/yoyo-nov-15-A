      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-xl border-2 border-green-100">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Physical Metrics</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-xl border-2 border-purple-100">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Technical Skills <span className="text-lg text-gray-600">(1-5 scale)</span></h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-xl border-2 border-pink-100">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Mental Attributes <span className="text-lg text-gray-600">(1-5 scale)</span></h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
