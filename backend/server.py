...
# =============================================================================
# LEGACY ASSESSMENT ROUTES - DEPRECATED
# =============================================================================
# These routes have been migrated to routes/assessment_routes.py using the
# service-repository pattern. The new routes are registered via:
#   api_router.include_router(assessment_router, prefix="/assessments", ...)
# See the "Include refactored routes" section at the bottom of this file.
# =============================================================================
...
# VO2 Max Benchmark routes moved to routes/vo2_routes.py (refactored to service/repository pattern)
