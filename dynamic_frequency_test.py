...
class DynamicFrequencyTest:
    ...
    async def test_total_training_days(self):
        ...
        try:
            ...
            total_weeks = 12  # As specified in program creation
            
            # Calculate expected total training days
            expected_totals = {
                3: total_weeks * 3,  # 36 days
                4: total_weeks * 4,  # 48 days  
                5: total_weeks * 5   # 60 days
            }
